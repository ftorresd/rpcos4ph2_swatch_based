#ifndef __SWATCH_MP7_CMDS_HARDRESETCOMMAND_HPP__
#define __SWATCH_MP7_CMDS_HARDRESETCOMMAND_HPP__
...
public:
  ...
  /**
   * @brief      Sends a hard reset signal to the board.
   *
...
#endif /* __SWATCH_MP7_CMDS_HARDRESETCOMMAND_HPP__ */