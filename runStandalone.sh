...
export SWATCHEXAMPLE_ROOT=${HERE}/rpcos4ph2


# SWATCH_DUMMY_INIT=${SWATCHEXAMPLE_ROOT}'/config/dummy.json'
SWATCH_DUMMY_INIT=${SWATCHEXAMPLE_ROOT}'/config/dummySystem.xml'
SWATCH_DUMMY_GATEKEEPER_XML=${SWATCHEXAMPLE_ROOT}'/config/config.xml'
...
export LD_LIBRARY_PATH=${SWATCHEXAMPLE_ROOT}/${XDAQ_PLATFORM}/lib:${LD_LIBRARY_PATH}
...
export SUBSYSTEM_CELL_LIB_PATH=${SWATCHEXAMPLE_ROOT}/${XDAQ_PLATFORM}/lib/librpcos4ph2_cell.so
export SUBSYSTEM_CELL_CLASS=rpcos4ph2::cell::Cell

export PWD_PATH=${SWATCHEXAMPLE_ROOT}/config
...
SUBSYSTEM_CELL_LIB_PATH+=";${CACTUS_ROOT}/lib/libcactus_swatch_mp7.so"
# SUBSYSTEM_CELL_LIB_PATH+=";/${SWATCH_ROOT}/mp7/test/lib/libcactus_swatch_mp7_test.so"
SUBSYSTEM_CELL_LIB_PATH+=";${CACTUS_ROOT}/lib/libcactus_swatch_amc13.so"
...
/opt/cactus/bin/swatchcell/runSubsystemCell.sh $ARGS
